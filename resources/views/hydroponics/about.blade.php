...
{{-- <div class="container section">
    ...
    <div class="card">
        <p style="color: var(--text-light); line-height: 1.8; font-weight: 300; letter-spacing: 0.02em; max-width: 650px;">
            Welcome to the Hydroponics Monitoring System. We provide real-time sensor data and analytics
            to optimize hydroponic farming practices, empowering farmers with innovative technology for sustainable agriculture.
        </p>
    </div>
</div> --}}
    ...
    <div class="features-grid">
        <div class="feature-card">
            <div class="feature-item">
                ...
                <div>
                    <h3 style="font-weight: 300; margin-bottom: 0.75rem; letter-spacing: 0.05em;">Real-time Monitoring</h3>
                    <p style="color: var(--text-light); font-size: 0.85rem; font-weight: 300; line-height: 1.7;">Track essential parameters instantly</p>
                </div>
            </div>
            ...
            <div class="feature-item" style="margin-bottom: 0;">
                <div class="feature-line"></div>
                <div>
                    <h3 style="font-weight: 300; margin-bottom: 0.75rem; letter-spacing: 0.05em;">Data Analytics</h3>
                    <p style="color: var(--text-light); font-size: 0.85rem; font-weight: 300; line-height: 1.7;">Comprehensive insights through visualization</p>
                </div>
            </div>
        </div>
        ...
        <div class="feature-card">
            <div class="feature-item">
                <div class="feature-line"></div>
                <div>
                    <h3 style="font-weight: 300; margin-bottom: 0.75rem; letter-spacing: 0.05em;">Alert System</h3>
                    <p style="color: var(--text-light); font-size: 0.85rem; font-weight: 300; line-height: 1.7;">Immediate notifications for parameter changes</p>
                </div>
            </div>
            ...
            <div class="feature-item" style="margin-bottom: 0;">
                <div class="feature-line"></div>
                <div>
                    <h3 style="font-weight: 300; margin-bottom: 0.75rem; letter-spacing: 0.05em;">Mobile Access</h3>
                    <p style="color: var(--text-light); font-size: 0.85rem; font-weight: 300; line-height: 1.7;">Monitor your system from anywhere</p>
                </div>
            </div>
        </div>
    </div>
