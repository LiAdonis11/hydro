...
@section('title', 'PH-4502C Liquid PH Sensor Dashboard')
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div class="p-6 flex items-center">
                    ...
                    <div>
                        ...
                        @endphp
                        <span class="block text-4xl font-bold">{{ $phValue }}</span>
                        <div class="flex items-center mt-1">
                            <span class="text-gray-500 text-sm mr-2">Status:</span>
                            <span class="font-medium {{ $statusColor }}">{{ $phStatus }}</span>
                        </div>
                        <span class="text-gray-500 text-sm block mt-1">Last updated: {{ $latestReading['timestamp'] ?? 'N/A' }}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-8">
            ...
            <div class="relative h-16">
                ...
                @if($phValue !== 'N/A')
                    ...
                    @endphp
                    <div class="absolute top-0 h-16 flex items-center" style="left: {{ $indicatorPosition }}%;">
